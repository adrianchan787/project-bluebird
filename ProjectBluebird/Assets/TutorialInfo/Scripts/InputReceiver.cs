...
public class InputReceiver : MonoBehaviour
{
    ...
    [SerializeField] private float vv_speed = 0.25f;
    ...
    void OnEnable()
    {
        // Bind functions to execute immediately when the action transitions to performed
    ...
    void OnDisable()
    {
        // Unsubscribe to ensure memory is cleanly managed when component is disabled or scene reloads
    ...
    // --- Automated Subscription Wrappers ---
